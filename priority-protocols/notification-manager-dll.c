/*
    ...
    notification-manager-dll.c

    An alternative doubly-linked-list implementation for the notification manager.
    Still under development, not for use!
    Needs to be modified so that the functions match the updated public interface.
